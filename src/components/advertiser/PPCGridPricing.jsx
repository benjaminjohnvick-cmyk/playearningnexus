    ...
    return (
      <div className="bg-green-900/30 border-2 border-green-500/50 rounded-2xl p-5 flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-gray-400 text-sm">Your ad is live on the Get Goods Gratis (Free) Million Dollar Ad Grid. Charges auto-deduct per your plan.</p>
        </div>
      </div>
    );
  }
    ...
    <div className="space-y-5">
      ...
      <div className="text-center">
        <div className="inline-flex items-center gap-2 bg-yellow-500/10 border border-yellow-500/30 rounded-full px-4 py-1.5 mb-3">
          ...
          <span className="text-yellow-300 text-xs font-bold">Get Goods Gratis (Free) Million Dollar Ad Grid</span>
        </div>
      ...
      <div className="bg-gray-900 border border-gray-700 rounded-2xl p-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs text-gray-400">
          {[
            'Spot on the Get Goods Gratis (Free) Million Dollar Ad Grid',
            '20 social posts auto-generated per click',
            'Get Goods Gratis (Free) logo + signup CTA on all ads',
