...
const NAV_SECTIONS = [
  ...
  { group: 'Affiliate', items: [
    { name: 'Affiliate Portal', icon: Megaphone, path: 'AffiliatePortal', color: 'purple' },
    { name: 'Affiliate Marketing', icon: Megaphone, path: 'AffiliateMarketingPage', color: 'purple' },
    { name: 'Affiliate MLM', icon: Users, path: 'AffiliateMLMDashboard', color: 'purple' },
    { name: 'Affiliate Tiers', icon: Star, path: 'AffiliateTierDashboard', color: 'purple' },
    { name: 'Affiliate Analytics', icon: TrendingUp, path: 'AffiliateAnalyticsDashboard', color: 'purple' },
    { name: 'Affiliate Onboarding', icon: Zap, path: 'AffiliateOnboarding', color: 'purple' },
    { name: 'Affiliate Payouts', icon: Wallet, path: 'AffiliatePayoutManager', color: 'purple' },
    { name: 'Affiliate Growth', icon: TrendingUp, path: 'AffiliateGrowthCampaignDashboard', color: 'purple' },
    { name: 'Content Library', icon: FileText, path: 'ContentLibraryBrowser', color: 'purple' },
    { name: 'Content Scheduler', icon: Bell, path: 'AffiliateContentSchedulerCalendar', color: 'purple' },
    { name: 'Marketing Assets', icon: Briefcase, path: 'MarketingAssetRepository', color: 'purple' },
    { name: 'Affiliate Disputes', icon: ShieldCheck, path: 'AffiliateDisputeCenter', color: 'purple' },
    { name: 'Churn Monitor', icon: Activity, path: 'AffiliateChurnMonitor', color: 'purple' },
    { name: 'Affiliate Store', icon: DollarSign, path: 'AffiliateMarketplace', color: 'purple' },
  ]},
  { group: 'Social', items: [
