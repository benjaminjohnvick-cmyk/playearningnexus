...
import { Youtube, Play, BarChart3, Loader2, CheckCircle } from 'lucide-react';
      ...
      <Card className="border-2 border-red-300 bg-gradient-to-br from-red-50 to-orange-50 p-6">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-4">
            Our AI agent will automatically add the Get Goods Gratis (Free) ad grid to your video intros and outros.
            Earn $0.20 per click!
          </p>
          <Button 
