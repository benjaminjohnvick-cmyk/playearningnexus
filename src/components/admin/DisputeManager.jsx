        ...
        <div className="px-4 pb-4 pt-2 bg-gray-50 border-t border-gray-100 space-y-3">
          ...
          {dispute.screenshot_url && (
            <div>
              <p className="text-xs font-semibold text-gray-500 uppercase mb-2 flex items-center gap-1">
                <Image className="w-3.5 h-3.5" /> Completion Screenshot
              </p>
              <a href={dispute.screenshot_url} target="_blank" rel="noopener noreferrer">
                <img src={dispute.screenshot_url} alt="Completion screenshot"
                  className="w-full max-h-48 object-cover rounded-lg border border-gray-200 hover:opacity-90 transition-opacity cursor-pointer" />
          ...
          {dispute.transaction_id && (
            <div className="bg-white border border-gray-200 rounded-lg px-3 py-2">
              <p className="text-xs font-semibold text-gray-500 uppercase mb-1">Linked Transaction</p>
              <p className="text-xs text-gray-700 font-mono">{dispute.transaction_id}</p>
              {dispute.transaction_date && (
                <p className="text-xs text-gray-400 mt-0.5">Date: {new Date(dispute.transaction_date).toLocaleDateString()}</p>
              )}
            </div>
          )}
