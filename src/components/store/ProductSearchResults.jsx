              ...
              <div className="flex gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex gap-2 mt-3 flex-wrap">
                    ...
                    >
                      <ShoppingBag className="w-3.5 h-3.5 mr-1" /> Order via Get Goods Gratis (Free)
                    </Button>
                  </div>
                </div>
              </div>
      ...
      <div className="sticky bottom-0 bg-gradient-to-t from-white via-white to-transparent px-4 pb-4 pt-6">
        <div className="bg-amber-50 border border-amber-200 rounded-lg p-3 flex gap-2">
          ...
          <p className="text-xs text-gray-700">
            <strong>Order via Get Goods Gratis (Free)</strong> — we purchase the item on your behalf. A 10% platform fee applies. Prices are real-time estimates and may vary.
          </p>
        </div>
      </div>
