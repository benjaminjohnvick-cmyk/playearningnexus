...
// GameStorePanel — an EXACT clone of the original Game Store page (src/pages/GameStore.jsx),
// repackaged as an embeddable component so it can live inside the App Store (Store.jsx) alongside
// the AppStoreBrowse GPU tiles + search. Same UI, same data, same behavior as the original page.
// The original standalone page was retired; a backup lives in code-backups/GameStore.original.jsx.
export default function GameStorePanel() {
