...
const SNIPPETS = [
  {
    ...
    text: (link, _name) => `💰 I've been earning real cash completing surveys on Get Goods Gratis (Free)! Join me and we both earn more. Use my link 👇\n${link}\n\n#GetGoodsGratis #EarnMoney #SideHustle`,
  },
  {
    platform: 'Facebook',
    icon: Facebook,
    color: 'bg-blue-600 text-white hover:bg-blue-700',
    text: (link, _name) => `Hey friends! 🎮 I've been using Get Goods Gratis (Free) to earn money in my spare time by completing surveys. It's legit and actually pays out!\n\nUse my personal invite link and we'll both get a bonus:\n${link}`,
  },
  {
    platform: 'LinkedIn',
    icon: Linkedin,
    color: 'bg-blue-700 text-white hover:bg-blue-800',
    text: (link, _name) => `Looking for a legitimate way to earn extra income? I've been using Get Goods Gratis (Free) — a survey & rewards platform that pays real money.\n\nJoin via my referral link and start earning today:\n${link}\n\n#SideIncome #EarnMoney #Productivity`,
  },
  {
    platform: 'WhatsApp / SMS',
    icon: MessageSquare,
    color: 'bg-green-500 text-white hover:bg-green-600',
    text: (link, _name) => `Hey! Thought you'd like this — I've been earning money on Get Goods Gratis (Free) taking surveys. Check it out with my link and we both earn a bonus: ${link}`,
  },
  {
    platform: 'Email',
    icon: Mail,
