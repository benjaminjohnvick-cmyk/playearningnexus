...
export default function WishlistGoalShare({ user, balance, threshold, progress }) {
  ...
  const shareText = `🎮 I'm ${progress.toFixed(0)}% of the way to my $${threshold.toFixed(2)} goal on Get Goods Gratis (Free)! I earn real money completing surveys. Join me! 💰`;
        ...
        <div className="bg-gradient-to-br from-purple-50 to-indigo-50 rounded-xl p-4 border border-purple-100">
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-semibold text-purple-800">My Get Goods Gratis (Free) Goal</span>
            </div>
