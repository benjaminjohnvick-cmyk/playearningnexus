  ...
  const handleShare = async (link = defaultLink) => {
    if (navigator.share) {
      await navigator.share({
        title: 'Join Get Goods Gratis (Free) — Earn Real Cash!',
        text: `I'm earning real cash playing games on Get Goods Gratis (Free)! Join me: `,
        url: link,
      });
    } else {
      handleCopy(link);
      ...
      <div className="rounded-2xl bg-gradient-to-br from-yellow-400 via-orange-400 to-red-500 p-0.5 shadow-xl">
        <div className="bg-gray-900 rounded-2xl p-5 text-white space-y-3">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs text-gray-400 uppercase tracking-widest">Get Goods Gratis (Free) Referral Card</p>
