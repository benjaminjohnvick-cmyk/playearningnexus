...
import { CheckCircle, Smartphone, Zap, ArrowRight } from 'lucide-react';
    ...
    <section className="max-w-7xl mx-auto px-6 py-12">
      <div className="text-center mb-10">
        ...
        <p className="text-gray-500 max-w-3xl mx-auto">
          Industry-standard pricing across CPI, CPA, and CPM models. Get Goods Gratis (Free) takes a <strong>10% platform cut</strong> of all ad spend —
      ...
      <div className="bg-gradient-to-r from-violet-600 to-purple-700 rounded-2xl p-6 text-white mb-8 text-center">
        <h3 className="text-xl font-black mb-2">💰 Revenue Split — 10% Get Goods Gratis (Free) / 90% Publisher</h3>
        <p className="text-purple-100 text-sm">
          Competitive advantage: AppLovin charges 20–30%, AdMob ~32%. Get Goods Gratis (Free) only takes 10% — attracting more developers to the flywheel.
        </p>
      </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-700 mb-3">
                ...
                and aligns Get Goods Gratis (Free)'s success with theirs.
              </p>
      ...
      <div className="bg-gray-50 border-2 border-gray-200 rounded-2xl p-6">
        <h3 className="font-black text-gray-900 mb-4 text-center">Get Goods Gratis (Free) Revenue Streams (AppLovin Model)</h3>
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {[
            ...
            { label: 'SDK Revenue Share', value: '10% take rate', sub: '90% to publisher, 10% to Get Goods Gratis (Free) on all ad volume' },
