...
const tiers = [
  {
    ...
    earnings: [
      ...
      { label: 'Platform share (50/50 split)', value: '$4.00/day to Get Goods Gratis (Free)', bold: false },
    ...
    note: 'During the first 2 days a new game is featured, Get Goods Gratis (Free) keeps 100% of the $8.00. Starting day 3, the 50/50 split applies and $1.00 of your $4.00 goes to the developer for 4 of 6 featured days.',
  },
  {
    name: 'Tier 2 — Growth',
    emoji: '🔵',
      ...
      <div className="mt-8 bg-gradient-to-br from-slate-900 to-gray-900 rounded-2xl p-8 text-white">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {[
            ...
            { label: 'Platform share (50%)', value: '$400,000/day', sub: 'Get Goods Gratis (Free) daily revenue' },
