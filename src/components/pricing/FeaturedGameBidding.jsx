...
import { ShieldCheck, TrendingUp, Star, Zap, CheckCircle } from 'lucide-react';
    ...
    <section className="max-w-7xl mx-auto px-6 py-12">
      ...
      <div className="bg-gradient-to-r from-slate-800 to-gray-900 rounded-2xl p-8 text-white">
        ...
        <p className="text-gray-400 text-xs">
          ...
          This allows Get Goods Gratis (Free) to continue promoting their app. All fees are deducted from ongoing developer earnings.
        </p>
