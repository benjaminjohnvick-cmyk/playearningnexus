        ...
        <div className="bg-gradient-to-r from-red-600 to-rose-600 px-6 py-4 flex items-center justify-between flex-shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-white/80 text-xs">Vote on mockups • The winner gets built into Get Goods Gratis (Free)!</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
        ...
        <div className="flex-1 overflow-y-auto px-6 py-5">
          {done ? (
            <div className="flex flex-col items-center justify-center py-10 gap-4">
              ...
              <p className="text-gray-500 text-sm text-center">Your votes help shape Get Goods Gratis (Free). The winning designs will be built this week.</p>
