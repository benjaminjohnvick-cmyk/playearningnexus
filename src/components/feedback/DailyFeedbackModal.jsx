        ...
        <div className="bg-gradient-to-r from-purple-600 to-blue-600 px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-white/80 text-xs">Help us improve Get Goods Gratis (Free) — takes ~3 minutes</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
          ...
          {done ? (
            ...
            <div>
              <div className="flex items-center gap-2 mb-1">
                ...
                <p className="text-gray-900 font-semibold text-base">What would make Get Goods Gratis (Free) better for you?</p>
              </div>
        ...
        {!done && (
          <div className="px-6 pb-5 flex items-center justify-between border-t pt-4">
            ...
            <p className="text-xs text-gray-400">
              {isSuggestionStep ? 'Your suggestion shapes Get Goods Gratis (Free)' : 'Survey closes at midnight'}
            </p>
