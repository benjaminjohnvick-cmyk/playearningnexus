...
const portals = [
  ...
  },
  {
    ...
    roi: [
      ...
      { label: '↳ Annual subscription', value: '$3,000' },
      { label: '↳ PPC Survey Ads (3,000 responses)', value: '$2,920' },
      { label: 'AI Ads value included FREE', value: '$12,000' },
      { label: 'Completion rate vs. industry avg', value: '~70% vs. 20–30%' },
    ],
    highlight: 'Full-Service $10,920/yr · Enterprise $15,920/yr — both include $3,000 subscription + $2,920 in PPC survey ads + $12,000 AI ad value. Auto-renewal annual.',
