...
const portals = [
  ...
  },
  {
    ...
    features: [
      '✅ DIY Annual Plan: 3,000 responses × $0.95 = $2,920/yr (auto-renewal)',
      '🎁 INCLUDES $12,000 in AI advertising value — FREE',
      '📈 We work with you until you DOUBLE your investment',
      'Full-Service projects: from $5,000 (managed end-to-end, auto-renewal)',
      'Enterprise plans: from $10,000 (custom panels & SLAs, auto-renewal)',
      'BitLabs surveys: no minimum, $0.50/response (separate pricing)',
      ...
      '🔄 All plans on automatic annual subscription renewal',
    ],
    roi: [
      { label: 'DIY Annual Plan (3,000 responses)', value: '$2,920/yr auto-renews' },
      { label: 'AI Ads value included FREE', value: '$12,000' },
      { label: 'Total value delivered', value: '$14,850+' },
      { label: 'Client net gain vs. spend', value: '$11,930+' },
      { label: 'Full-Service project (starting)', value: '$5,000/yr' },
      { label: 'Enterprise plan (starting)', value: '$10,000/yr' },
      { label: 'Completion rate vs. industry average', value: '~70% vs. 20–30%' },
    ],
    highlight: '3,000 responses + $12,000 AI ads value for $2,920/yr — we keep working until you double your investment. Auto-renewal annual subscription.',
