...
const portals = [
  ...
  },
  {
    ...
    features: [
      ...
      '🎁 INCLUDES $12,000 in AI advertising value — FREE with paid tiers',
      '📈 We work with you until you DOUBLE your investment',
      '— — — PAID TIERS (annual auto-renewal) — — —',
      '📦 Full-Service: $5,000 platform + $3,000/yr subscription + $2,920 PPC surveys = $10,920/yr',
      '🔁 Full-Service Guarantee: We keep working until you earn 2× your $10,920 = $21,840 in ROI',
      '🎯 Full-Service Bonus: PLUS an additional 2× ($21,840) in FREE AI platform advertising',
      '🏢 Enterprise: $10,000 platform + $3,000/yr subscription + $2,920 PPC surveys = $15,920/yr',
      '🔁 Enterprise Guarantee: We keep working until you earn 2× your $15,920 = $31,840 in ROI',
      '🎯 Enterprise Bonus: PLUS an additional 2× ($31,840) in FREE AI platform advertising',
    ...
    roi: [
      ...
      { label: 'Full-Service annual total', value: '$10,920/yr' },
      { label: '↳ Platform fee', value: '$5,000' },
      { label: '↳ Annual subscription', value: '$3,000' },
      { label: '↳ PPC Survey Ads (3,000 responses)', value: '$2,920' },
      { label: 'Enterprise annual total', value: '$15,920/yr' },
      { label: '↳ Platform fee', value: '$10,000' },
      { label: '↳ Annual subscription', value: '$3,000' },
      { label: '↳ PPC Survey Ads (3,000 responses)', value: '$2,920' },
      { label: 'Full-Service ROI guarantee (2×)', value: '$21,840' },
      { label: 'Full-Service free AI ads bonus (2×)', value: '$21,840' },
      { label: 'Enterprise ROI guarantee (2×)', value: '$31,840' },
      { label: 'Enterprise free AI ads bonus (2×)', value: '$31,840' },
      { label: 'Completion rate vs. industry avg', value: '~70% vs. 20–30%' },
    ],
    highlight: 'Full-Service $10,920/yr: we work until you earn $21,840 in ROI + $21,840 in FREE AI ads. Enterprise $15,920/yr: we work until you earn $31,840 in ROI + $31,840 in FREE AI ads. Our commitment — you always win.',
