...
const portals = [
  ...
  },
  {
    ...
    description: 'Build and publish surveys to a pre-verified, engaged audience. GamerGain users are incentivized to complete surveys daily — giving you higher completion rates than traditional platforms.',
    features: [
      '$0.10 per question per respondent — transparent flat pricing',
      ...
      'Scheduled distribution for timed research windows',
    ],
    roi: [
      { label: 'Cost per response vs. SurveyMonkey', value: '$0.10/q vs. $3–$5/response' },
      { label: 'Completion rate vs. industry average', value: '~70% vs. 20–30%' },
      { label: 'Response fraud filtering', value: 'Built-in (free)' },
      { label: 'Time to 1,000 responses', value: 'Hours, not weeks' },
    ],
    highlight: 'Get 10× more responses at 1/30th the cost of traditional survey platforms — with built-in fraud detection.',
  ...
  },
  {
    ...
    description: 'Run PPC campaigns inside a platform where users are already paying attention and completing tasks for rewards. Every ad is seen by an active, incentivized audience — not bots or passive scrollers.',
    features: [
      ...
      'Retargeting via wishlist and search behavior data',
      'Daily and weekly campaign performance reports',
      'Fraud detection engine on every click and interaction',
    ],
    roi: [
      { label: 'Cost per engaged action vs. Meta/Google', value: '$0.40 vs. $2–$15 CPC' },
      { label: 'Click-through rate (engaged users)', value: '3–8× higher than industry avg' },
      { label: 'Social amplification via referral network', value: 'Free with every campaign' },
      { label: 'Ad fraud rate', value: '<1% (AI-monitored)' },
    ],
    highlight: 'Pay $0.40 per completed ad task — a fraction of Meta and Google\'s average CPC, with verified human engagement.',
