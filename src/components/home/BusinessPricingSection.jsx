...
const portals = [
  ...
  },
  {
    ...
    description: 'Build and publish surveys to a pre-verified, engaged audience. Choose DIY self-serve, or unlock our managed tiers — each includes 3,000 PPC survey responses ($2,920) and a $3,000/yr platform subscription.',
    features: [
      '✅ DIY Pay-Per-Response: from $0.95/response (no minimum)',
      '🎁 INCLUDES AppLovin-style AI ad mediation + user acquisition — FREE with paid tiers',
      '📈 We work with you until you DOUBLE your investment',
      '— — — PAID TIERS (annual auto-renewal) — — —',
      '📦 Full-Service: $8,999 platform + $3,000/yr subscription + $3,000 PPC surveys + AI Ad Engine = $14,999/yr',
      '🔁 Full-Service Value Guarantee: we deliver at least 2× your $14,999 = $29,998 in advertising value (value-matched to your spend; not a revenue or ROI guarantee)',
      '🎯 Full-Service Bonus: PLUS an additional 2× ($29,998) in FREE AI platform advertising',
      '🏢 Enterprise: $23,999 platform + $3,000/yr subscription + $3,000 PPC + AXON AI + CTV = $29,999/yr',
      '🔁 Enterprise Value Guarantee: we deliver at least 2× your $29,999 = $59,998 in advertising value (value-matched to your spend; not a revenue or ROI guarantee)',
      '🎯 Enterprise Bonus: PLUS an additional 2× ($59,998) in FREE AI platform advertising',
      'BitLabs surveys: no minimum, $0.50/response (add-on)',
      ...
      '🔄 Both paid tiers on automatic annual subscription renewal',
    ],
    roi: [
      { label: 'DIY (per response)', value: '$0.95/response' },
      { label: 'Full-Service annual total', value: '$14,999/yr' },
      { label: '↳ Platform fee', value: '$8,999' },
      { label: '↳ Annual subscription', value: '$3,000' },
      { label: '↳ PPC Survey Ads + AI Ad Mediation', value: '$3,000' },
      { label: 'Enterprise annual total', value: '$29,999/yr' },
      { label: '↳ Platform fee', value: '$23,999' },
      { label: '↳ Annual subscription', value: '$3,000' },
      { label: '↳ PPC + AXON AI + CTV Inventory', value: '$3,000' },
      { label: 'Full-Service value guarantee (2×)', value: '$29,998' },
      { label: 'Full-Service free AI ads bonus (2×)', value: '$29,998' },
      { label: 'Enterprise value guarantee (2×)', value: '$59,998' },
      { label: 'Enterprise free AI ads bonus (2×)', value: '$59,998' },
      { label: 'Completion rate vs. industry avg', value: '~70% vs. 20–30%' },
    ],
    highlight: 'Full-Service $14,999/yr: at least $29,998 in advertising value delivered + $29,998 in FREE AI ads. Enterprise $29,999/yr: at least $59,998 in advertising value delivered + $59,998 in FREE AI ads — plus AXON AI & CTV. Every tier is value-matched to your spend — advertising value delivered, never a revenue or ROI promise.',
  ...
  },
  {
    ...
    features: [
      ...
      'Full ad-network metrics — eCPM, CPP, ROAS by D1–D365, fill rate, ARPDAU & retention, measured from real activity',
      'Demographic targeting (age, gender, country, region) + new-vs-existing-user audiences',
      'AI delivery optimization — optimize for ROAS, new-user acquisition, or existing-user retention',
