...
const DEMO_CAMPAIGNS = [
  ...
  },
  {
    ...
    ai_generated_pitch: 'Get Goods Gratis (Free) deserves to be in your pocket. With a native mobile app, you could earn while commuting, play surveys during lunch, and never miss a tournament — all offline-capable. Your backing will bring Get Goods Gratis (Free) to iOS and Android with full feature parity.'
  },
  {
    id: 'c3', title: 'Community Game Jam Fund', category: 'community',
    description: 'Annual prize pool for indie game developers building on Get Goods Gratis (Free).',
