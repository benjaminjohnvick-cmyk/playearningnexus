...
export default function MarketResearchPanel({ userTier: _userTier = 'free' }) {
  ...
  const DEMO_REPORTS = [
    ...
    },
    {
      ...
      summary: 'AI-forecasted product category demand based on wishlist, purchase, and browsing data from Get Goods Gratis (Free) users.',
    ...
    },
    {
      ...
      summary: 'Detailed breakdown of Get Goods Gratis (Free) user demographics including age, geography, income, and gaming preferences.',
