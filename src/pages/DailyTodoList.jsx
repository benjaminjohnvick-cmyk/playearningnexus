...
const CORE_TASKS = [
  ...
  },
  {
    ...
    description: 'Use the Shop button on the Get Goods Gratis (Free) search widget to search for 1 product. $0.05 is auto-deducted. The product is added to your Wishlist, and you receive contest entries automatically.',
...
const EXTRA_MANDATORY_TASKS = [
  ...
  },
  {
    ...
    title: 'Download the Get Goods Gratis (Free) Search Widget',
    description: 'Install the Get Goods Gratis (Free) search widget for automatic ad earnings and contest entries.',
  ...
  },
  {
    ...
    description: 'View your contest entries and current ranking for the Get Goods Gratis (Free) prize pool.',
  ...
  const loadAITasks = async (u) => {
    ...
    try {
      const res = await base44.integrations.Core.InvokeLLM({
        prompt: `Generate 5 personalized daily earn-section tasks for Get Goods Gratis (Free) user ${u?.full_name || 'User'} (earnings: $${(u?.total_earnings || 0).toFixed(2)}).
