            ...
            <Card className="border-0 shadow-lg">
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <Input type="email" placeholder="your@paypal.com" value={paypalEmail}
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <Input type="number" placeholder={`Min $${MIN_WITHDRAWAL}`} value={amount}
                      ...
                      className="pl-7 border-2 text-lg" min={MIN_WITHDRAWAL} max={balance} step="0.01" />
                  </div>
                  ...
                  <div className="space-y-3">
                    <div className="flex gap-3 text-xs flex-wrap mb-2">
                      {['pending', 'processing', 'completed', 'failed'].map(s => {
                        ...
                        return <span key={s} className={`px-2 py-1 rounded-full ${cfg.color} font-medium`}>{cfg.label}: {count}</span>;
                      })}
                    </div>
                    {payouts.map((payout) => {
