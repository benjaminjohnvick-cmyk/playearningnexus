      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-500 text-lg max-w-2xl mx-auto">
            Copy a single code snippet and paste it into any website. Responses are tracked directly back to your Get Goods Gratis (Free) account.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-4">
          {[
            ...
            { icon: BarChart2, title: '3. Track Responses', desc: 'All completions sync back to your Get Goods Gratis (Free) dashboard in real time.', color: 'bg-green-50 border-green-200' },
