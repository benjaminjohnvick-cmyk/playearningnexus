...
export default function ReferralHub() {
  ...
  const shareOnTwitter = () => window.open(`https://twitter.com/intent/tweet?text=Join%20Get%20Goods%20Gratis%20and%20earn%20real%20money!%20${encodeURIComponent(referralLink)}`, '_blank');
  const shareOnFacebook = () => window.open(`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(referralLink)}`, '_blank');
  const shareViaWhatsApp = () => window.open(`https://wa.me/?text=Join%20Get%20Goods%20Gratis%20and%20earn%20real%20money!%20${encodeURIComponent(referralLink)}`, '_blank');
