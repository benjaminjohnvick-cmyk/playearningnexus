...
export default function ReferralDashboard() {
  ...
  const totalReferrerEarnings = totalEarnings * 0.25; // 25% of referrals' earnings
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">Earn 25% of everything your referrals make</p>
        </div>
        ...
        <div className="grid md:grid-cols-4 gap-6 mb-8">
          ...
          <Card className="border-0 shadow-lg">
            ...
            <CardContent>
              <p className="text-3xl font-bold text-green-600">${totalReferrerEarnings.toFixed(2)}</p>
              <p className="text-xs text-gray-500 mt-1">25% commission</p>
            </CardContent>
          </Card>
                ...
                referrals.map((referral) => (
                  <div key={referral.id} className="p-4 border rounded-lg bg-gray-50 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-6">
                      ...
                      <div className="text-right">
                        <p className="text-sm font-medium text-gray-600">Your Commission (25%)</p>
                        <p className="text-xl font-bold text-green-600">
                          ${((referral.total_earnings || 0) * 0.25).toFixed(2)}
                        </p>
                      </div>
                ...
                {achievements.map((achievement) => (
                  <div key={achievement.id} className="p-4 border rounded-lg bg-gradient-to-br from-yellow-50 to-orange-50">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-bold text-gray-900">{achievement.badge_name}</p>
                        <p className="text-sm text-gray-600">+{achievement.points_awarded} points</p>
                        {achievement.bonus_reward > 0 && (
                          <p className="text-sm font-medium text-green-600">
                            +${achievement.bonus_reward} bonus
                          </p>
                        )}
                      </div>
                    </div>
