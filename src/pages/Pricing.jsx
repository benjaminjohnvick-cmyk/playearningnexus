...
export default function Pricing() {
  ...
  return (
    <div className="min-h-screen bg-white pointer-events-auto">
      ...
      {/* Get Goods Gratis (Free) Double Guarantee — top of page */}
                  ...
                  {[
                    {
                      ...
                      features: [
                        ...
                        'Full ad-network metrics dashboard — eCPM, CPM, IPM, CPP, ROAS by D1–D365 window, fill rate, ARPDAU & retention, all measured',
                        'AI delivery optimization from measured results (never raises your spend, never guarantees a return)',
                    ...
                    },
                    {
                      ...
                      features: [
                        ...
                        'Advanced demographic targeting — age, gender, country & region — plus new-vs-existing-user audiences',
                        'Optimize delivery for ROAS, new-user acquisition, or existing-user retention',
                    ...
                    <Card key={i} className={`bg-white/10 backdrop-blur border-2 ${tier.borderColor} text-white`}>
                      <CardContent className="p-6">
                        ...
                        <div className="bg-white/10 rounded-xl px-4 py-3 mb-4 border border-white/20">
                          ...
                          <p className="text-xs text-purple-200 leading-snug">Developers can pay for this tier directly from their Get Goods Gratis (Free) developer earnings — no out-of-pocket payment required. Earnings are automatically applied at checkout.</p>
                        </div>
