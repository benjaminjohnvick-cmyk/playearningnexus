    ...
    >
      ...
      >
        ...
        <p className="text-center text-gray-500 text-[10px] mt-4">
          You earn $0.20 · Get Goods Gratis (Free) earns $0.20 · Business gets discovered
        </p>
      </motion.div>
    </motion.div>
  );
    ...
    <div className="min-h-screen bg-gray-950 text-white">
      ...
      <div className="max-w-5xl mx-auto px-4 pt-8 pb-4 text-center">
        ...
        <p className="text-gray-300 text-sm max-w-2xl mx-auto mb-2">
          ...
          The other $0.25 goes to Get Goods Gratis (Free). Then visit the business!
        </p>
      ...
      <div className="max-w-5xl mx-auto px-4 pb-16">
        ...
        <p className="text-center text-gray-600 text-xs mt-3">
          Grid auto-expands as new businesses join · Pixel size auto-adjusts · Powered by Get Goods Gratis (Free).app
        </p>
      </div>
