...
import { ShoppingBag, Zap, TrendingUp, DollarSign, CheckCircle, RefreshCw, Gift } from 'lucide-react';
...
const MARKETPLACE_ITEMS = [
  {
    ...
    description: 'Instantly usable on any game, bundle, or digital item in the Get Goods Gratis (Free) store.',
    icon: '🛒',
    valueUsd: 5,
    discountPct: 10,
    costEarnings: 4.50,
  ...
  },
  {
    ...
    description: '500 targeted impressions + 50 clicks across the Get Goods Gratis (Free) ad grid.',
    icon: '📢',
    valueUsd: 15,
    discountPct: 20,
    costEarnings: 12,
