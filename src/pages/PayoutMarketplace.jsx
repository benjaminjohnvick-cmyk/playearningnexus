...
const MARKETPLACE_ITEMS = [
  {
    ...
    description: 'Instantly usable on any game, bundle, or digital item in the Grandia Granaria store.',
    icon: '🛒',
    valueUsd: 5,
    discountPct: 10,
    costEarnings: 4.50,
  ...
  },
  {
    ...
    description: '500 targeted impressions + 50 clicks across the Grandia Granaria ad grid.',
    icon: '📢',
    valueUsd: 15,
    discountPct: 20,
    costEarnings: 12,
