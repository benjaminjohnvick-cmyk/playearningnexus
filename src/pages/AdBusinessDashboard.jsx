    ...
    return (
      <div className="min-h-screen bg-gray-950 flex items-center justify-center p-6 text-center">
        <div>
          ...
          <p className="text-gray-400 mb-6">Sign in to manage your ads on the Get Goods Gratis (Free) Million Dollar Ad Grid</p>
          <Button
    ...
    <div className="min-h-screen bg-gray-950 text-white">
        ...
        <div className="max-w-5xl mx-auto px-4 py-4 flex items-center justify-between gap-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-gray-500 text-xs">Get Goods Gratis (Free) Million Dollar Ad Grid</p>
            </div>
          </div>
      ...
      <div className="max-w-5xl mx-auto px-4 py-8">
            ...
            {ads.length === 0 && !showForm ? (
              <div className="text-center py-20">
                ...
                <p className="text-gray-500 mb-6 max-w-sm mx-auto">
                  Submit your first ad to appear on the Get Goods Gratis (Free) Million Dollar Ad Grid.
                </p>
                <Button
        ...
        {activeTab === 'Loyalty' && (
          <div className="space-y-6">
            <h2 className="text-sm font-bold text-gray-400 uppercase tracking-wider flex items-center gap-2">
              <Star className="w-4 h-4 text-yellow-400" /> Get Goods Gratis (Free) Points & Loyalty Rewards
            </h2>
        ...
        {activeTab === 'Social Analytics' && (
          <div className="space-y-6">
            ...
            <p className="text-gray-500 text-xs">Performance tracking across Meta, Google, TikTok, X, and Snapchat — with a full market cost comparison showing what you'd pay vs. Get Goods Gratis (Free).</p>
