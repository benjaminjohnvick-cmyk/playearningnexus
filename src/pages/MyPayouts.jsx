...
import { DollarSign, Clock, CheckCircle2, AlertCircle, Settings, CreditCard, Calendar, TrendingUp } from 'lucide-react';
...
export default function MyPayouts() {
  ...
  const nextPayoutDate = () => {
    ...
    const now = new Date();
    if (freq === 'weekly') { now.setDate(now.getDate() + (7 - now.getDay())); }
    else if (freq === 'biweekly') { now.setDate(now.getDate() + 14); }
    else { now.setMonth(now.getMonth() + 1, 1); }
