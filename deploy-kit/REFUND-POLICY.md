...
- **Businesses / advertisers** receive refunds as **refund credit** (a separate `refund_credit_balance`).
...
## 3. What you can buy with credit

Store credit and refund credit can be spent on:

- **Physical products** — sourced and shipped to your address by AI order fulfillment.
- **Online services** — digital services fulfilled and delivered to your account (no shipping).

In every case, **AI automatically fills the order** (sources the item or service, checks out, and
arranges delivery). You don't place the order manually.

## 4. Business (advertiser) refunds — the PPC AdGrid 50% refund

Advertisers on the $5,000 annual PPC AdGrid earn a partial refund tied to their matched premium user's
activity:
...
- Refund credit accrues while the user is repaying their advance and can be spent at any time on
  products or online services, markup-free.

## 5. Customer refunds

- **Undelivered / unfulfillable orders:** if AI order fulfillment cannot source and deliver an item or
  service you paid for, the full amount is refunded to your store credit.
- **Damaged / not-as-described physical goods:** report within 14 days of delivery; approved cases are
...
Contact support through the in-app AI support chat or your account's Support page. Most eligible
refunds are issued automatically to store credit; contested cases are reviewed by a human within the
timelines above.

## 7. Timing & limits

- Automatic refunds (unfulfillable orders) post to store credit immediately.
- Reviewed refunds are resolved within 5 business days of a complete report.
- Refund credit and store credit do not expire while your account is active.
