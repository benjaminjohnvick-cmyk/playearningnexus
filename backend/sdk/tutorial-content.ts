...
export const TUTORIAL: Record<Track, { label: string; intro: string; steps: Step[] }> = {
  non_business: {
    ...
    steps: [
      ...
      { id: "buddy_schedule", title: "Schedule your next chat", body: "When a Buddy Chat session ends, pick a time to meet again the next day. The app remembers it and pops Buddy Chat open at that moment — in your own timezone — so you don't have to keep track. If your buddy is in another part of the world, that's fine: you each pick your own local time, and if you chose the same real-world moment, you're matched together. Available to everyone, premium or not.", target: "/buddychat", tryIt: "At the end of a chat, tap 'Schedule next chat' and pick a time for tomorrow." },
      { id: "buddy_match", title: "Find the right buddy", body: "You can be matched automatically with someone new who shares your interests — that comes from your first (KYC) survey, so the more honestly you answer, the better the match. Prefer to choose for yourself? Browse buddy profiles and pick one. Profiles are privacy-safe: they show a first name and interests only — never your email, full name, age, or any private answers — and browsing is opt-in, so you only appear if you switch your own profile on. Picking someone sends them an invite; it's never a forced pairing, and Leave/Report always work.", target: "/buddychat", tryIt: "Tap 'Browse & pick a buddy' to see who shares your interests, or 'Schedule with a new buddy' to be matched automatically." },
...
export const FAQ: Array<{ q: string; a: string }> = [
  ...
  { q: "How does Buddy Chat matching work, and is it private?", a: "Two ways: you can be auto-matched with a new person who shares your interests (from your first survey), or browse profiles and pick your own buddy. Profiles show only a first name and interests — never your email, full name, age, or private answers — and appearing in the directory is opt-in. Picking someone sends an invite; no one is ever force-paired, and you can Leave or Report at any time." },
  { q: "Can I schedule Buddy Chat for later?", a: "Yes. At the end of a session you pick a time to meet again the next day, and the app opens Buddy Chat for you at that moment in your own timezone. Buddies in different timezones who pick the same real-world moment are matched together, each seeing their own local time. It works for premium and non-premium members alike." },
];
