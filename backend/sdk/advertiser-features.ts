...
const CATALOG: AdvertiserFeatureDef[] = [
  ...
  { key: "live_shopping_placement", name: "Live-shopping / livestream placement", tier: 1, base_value_usd: 9000, revenue_type: "advertising", status: "counsel", gate_flag: "SESSION_HOSTING_ENABLED", category: 1, basis: "live-shopping video placement (host features & sells the advertiser's product live; audio/video ad breaks); activates after counsel sign-off" },
  { key: "livestream_social_amplification", name: "Livestream shared to member social feeds", tier: 1, base_value_usd: 4000, revenue_type: "advertising", status: "counsel", gate_flag: "HOSTING_SOCIAL_SIMULCAST_ENABLED", category: 1, basis: "the advertiser's live session is announced to consenting members' connected social feeds (#ad), adding social reach/impressions; activates after counsel sign-off" },
