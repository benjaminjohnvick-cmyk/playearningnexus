...
export const REGISTRY: SettingDef[] = [
  ...
  { key: "POINTS_REDEEM_MAX_PCT_NONPREMIUM", label: "Points spend cap per purchase — non-premium", category: "Surveys", type: "number", default: "0.12", unit: "×", help: "Max share of an item's price a NON-PREMIUM user can pay with points in a single purchase. 0.12 = 12%.", min: 0, max: 1 },
  { key: "POINTS_REDEEM_MAX_PCT_PREMIUM", label: "Points spend cap per purchase — premium", category: "Surveys", type: "number", default: "0.24", unit: "×", help: "Max share of an item's price a PREMIUM user can pay with points in a single purchase. 0.24 = 24%. (Premium can also draw a larger chunk up front.)", min: 0, max: 1 },
