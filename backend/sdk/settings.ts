...
export const REGISTRY: SettingDef[] = [
  ...
  { key: "FOUNDING_STORE_CREDIT_POINTS", label: "Founding store-credit grant (points)", category: "Founding Advertiser", type: "number", default: "800000", unit: "points", help: "A founding STORE-CREDIT grant in points (closed-loop, non-cashable — spends only on-site). Represented and disclosed as store credit, NEVER as a dollar value or a return. A discretionary membership benefit, not a refund; only useful while the store operates.", min: 0 },
  { key: "FOUNDING_STORE_CREDIT_RELEASE_YEARS", label: "Founding store-credit release years", category: "Founding Advertiser", type: "number", default: "4", unit: "years", help: "Release the founding store-credit grant in equal annual tranches over this many years (4 = 25%/year).", min: 1 },
  { key: "FOUNDING_SURVEY_EARN_SHARE_PCT", label: "Founding survey earn share", category: "Founding Advertiser", type: "number", default: "1", unit: "×", help: "Founding members keep this share of what they earn from surveys (1 = 100%). The AMOUNT is still variable and not guaranteed — this is the share of whatever they earn, not a promised figure.", min: 0, max: 1 },
