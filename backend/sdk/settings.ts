...
export const REGISTRY: SettingDef[] = [
  ...
  { key: "BUDDY_DEFAULT_NONPREMIUM", label: "Buddy default for non-premium", category: "Surveys", type: "boolean", default: "1", help: "Paired earning is the encouraged default for non-premium. A solo fallback ALWAYS exists — this is a nudge, never a lockout." },
