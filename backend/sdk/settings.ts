...
export const REGISTRY: SettingDef[] = [
  ...
  { key: "FOUNDING_ESCROW_REQUIRED", label: "Hold founding funds in escrow", category: "Founding Advertiser", type: "boolean", default: "1", help: "Founding payments are held in escrow until the launch milestone is met; refunded if it isn't. Requires a real escrow arrangement + counsel. Keep ON." },
