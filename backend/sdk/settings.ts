...
export const REGISTRY: SettingDef[] = [
  ...
  { key: "FOUNDING_FULLKEEP_CAP_TO_PRICE", label: "Founding full-keep cap = amount paid", category: "Founding Advertiser", type: "boolean", default: "1", help: "Cap the founding 100%-keep survey benefit at the amount the member paid. WARNING: pegging the cap to the payment reads as return-of-capital; keep the member-facing copy as a variable, not-guaranteed CAP, never a promise to 'earn it back'." },
  { key: "FOUNDING_FULLKEEP_CAP_USD", label: "Founding full-keep cap (if not = price)", category: "Founding Advertiser", type: "number", default: "0", unit: "$", help: "Explicit cumulative cap on the founding 100%-keep benefit, used only when the cap-to-price toggle is OFF. 0 = none.", min: 0 },
  { key: "FOUNDING_FULLKEEP_YEARS", label: "Founding full-keep window (years)", category: "Founding Advertiser", type: "number", default: "4", unit: "years", help: "The 100%-keep founding benefit lasts at most this many years (or until the cap is reached, whichever comes first), then the member reverts to standard survey-reward terms.", min: 1 },
