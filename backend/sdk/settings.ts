...
export const REGISTRY: SettingDef[] = [
  ...
  { key: "CATALOG_LISTINGS_PER_COUNTRY", label: "Catalog listings per country", category: "Marketplace", type: "number", default: "24", min: 0, max: 500, help: "Target number of original platform listings to keep active per country. The seeder tops up toward this." },
