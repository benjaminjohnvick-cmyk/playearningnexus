...
export const REGISTRY: SettingDef[] = [
  ...
  { key: "PPC_GRID_ANNUAL_PRICE", label: "PPC AdGrid annual price", category: "Premium PPC", type: "number", default: "12000", unit: "$", help: "What an advertiser pays for a year of PPC AdGrid ($12,000/yr, paid upfront). Funds the matched member's benefits." },
  { key: "PPC_GRID_MONTHLY_PRICE", label: "PPC AdGrid monthly price", category: "Premium PPC", type: "number", default: "1000", unit: "$", help: "Monthly option for PPC AdGrid ($1,000/mo, paid upfront each month). 12 × $1,000 = $12,000/yr.", min: 0 },
  { key: "PPC_ADVERTISER_SURVEY_OPTIN_ENABLED", label: "PPC advertiser survey opt-in", category: "Premium PPC", type: "boolean", default: "1", help: "Show an OPTIONAL choice on PPC advertiser signup to also participate as a survey-taker. When on, the advertiser can opt in to fill out surveys served by the third-party survey providers (BitLabs, CPX, AdGate, Respondent, etc.)." },
  { key: "PPC_ADVERTISER_SURVEY_PROVIDER", label: "PPC advertiser survey source", category: "Premium PPC", type: "string", default: "third_party", help: "Which surveys an opted-in advertiser fills out. 'third_party' routes them to the external survey providers only (never the platform's own PPC surveys), so their responses stay independent of their own campaigns." },
  ...
  { key: "SURVEY_INTERSTITIAL_PPC_PRIORITY", label: "PPC advertiser ads in the between-survey slot", category: "Scale & Platform", type: "boolean", default: "1", help: "Serve paying PPC-grid advertisers' active creatives in the mandatory between-survey slot (after any founding-advertiser priority, before house ads). Guarantees advertisers who pay for the AdGrid get placed in the interstitial." },
  ...
  { key: "FOUNDING_ADVERTISER_ENABLED", label: "Tier 1 advertising offer", category: "Founding Advertiser", type: "boolean", default: "1", help: "Enable the limited introductory 'Tier 1' advertising offer. Sells an advertising product on its own merits, PLUS a separate membership perk (keep 100% of your own survey earnings for a window). Never an investment or a guaranteed return." },
  { key: "FOUNDING_ADVERTISER_SLOTS", label: "Tier 1 availability cap (advertisers)", category: "Founding Advertiser", type: "number", default: "100000", unit: "advertisers", help: "The Tier 1 introductory offer stays OPEN until this many Tier 1 advertisers have enrolled, then closes. After it closes, new members keep only the post-Tier-1 share of their survey earnings (see TIER1_POST_SURVEY_SHARE_PCT). Scarcity/availability is a marketing lever, not a promise of returns.", min: 0 },
  { key: "TIER1_POST_PLATFORM_FEE_PCT", label: "Post-Tier-1 platform fee", category: "Founding Advertiser", type: "number", default: "0.25", unit: "×", help: "The platform fee taken from a post-Tier-1 member's own third-party survey revenue (0.25 = platform keeps 25%, member keeps 75%). Applies to members who join AFTER the Tier 1 offer closes, and to Tier 1 members after their 100%-keep window ends. Tier 1 members in-window pay NO fee (they keep 100%). Existing members are unaffected by later changes. Adjust this to set the platform's cut; the member's keep-share is 1 − this. Paid as closed-loop Site Cash; amounts are variable and not guaranteed.", min: 0, max: 1 },
  // ── Tier 1 VALUE STACK — real, included deliverables/features (product value, NEVER a financial return). ──
  { key: "TIER1_LAUNCH_BONUS_IMPRESSIONS", label: "Tier 1 launch bonus impressions", category: "Founding Advertiser", type: "number", default: "100000", unit: "impressions", help: "One-time bonus ad impressions added on top of the yearly allotment for Tier 1 members (a delivered advertising bonus, not a dollar value). 0 = none.", min: 0 },
  { key: "TIER1_INCLUDE_PREMIUM", label: "Tier 1 includes Premium membership", category: "Founding Advertiser", type: "boolean", default: "1", help: "Tier 1 members get Premium membership included at no extra cost (highest survey inventory + perks). A delivered membership benefit." },
  { key: "TIER1_AI_CREATIVE_INCLUDED", label: "Tier 1 includes free AI ad creative", category: "Founding Advertiser", type: "boolean", default: "1", help: "Free AI-generated ad creatives + product-page copy for Tier 1 campaigns (a delivered service)." },
  { key: "TIER1_AI_SOCIAL_POSTS_PER_MONTH", label: "Tier 1 free AI social posts / month", category: "Founding Advertiser", type: "number", default: "30", unit: "posts", help: "Free AI-written, clearly-labeled social ad posts generated per month for Tier 1 members (a delivered service). 0 = none.", min: 0 },
  { key: "TIER1_AB_TESTING_INCLUDED", label: "Tier 1 includes creative A/B testing", category: "Founding Advertiser", type: "boolean", default: "1", help: "Free automated A/B testing of Tier 1 ad creatives to find the best performer (a delivered feature)." },
  { key: "TIER1_ANALYTICS_INCLUDED", label: "Tier 1 includes real-time analytics", category: "Founding Advertiser", type: "boolean", default: "1", help: "Real-time impression/click analytics and ROI reporting for Tier 1 campaigns (a delivered feature)." },
  { key: "TIER1_SENTIMENT_INSIGHTS_INCLUDED", label: "Tier 1 includes consumer-sentiment insights", category: "Founding Advertiser", type: "boolean", default: "1", help: "Aggregate, anonymized consumer-sentiment insights drawn from survey responses to the member's ad questions (a delivered feature; aggregate-only, no personal data)." },
  { key: "TIER1_FEATURED_PLACEMENT", label: "Tier 1 featured placement", category: "Founding Advertiser", type: "boolean", default: "1", help: "Tier 1 members' creatives get featured/priority placement in the between-survey slot and on a Tier 1 sponsors wall (a delivered placement benefit)." },
  { key: "TIER1_PRIORITY_SUPPORT", label: "Tier 1 priority support", category: "Founding Advertiser", type: "boolean", default: "1", help: "Priority/concierge support for Tier 1 members (a delivered service)." },
  { key: "TIER1_LOCKED_RENEWAL", label: "Tier 1 locked-in renewal rate", category: "Founding Advertiser", type: "boolean", default: "1", help: "Tier 1 members keep their locked-in introductory advertising rate at renewal, for as long as they stay (a delivered pricing benefit — a rate lock, never a promised return)." },
  { key: "TIER1_EARLY_ACCESS", label: "Tier 1 early access to new surfaces", category: "Founding Advertiser", type: "boolean", default: "1", help: "Tier 1 members get early access to new ad surfaces/features as they ship (a delivered benefit)." },
  // ── EARNED / FREE advertiser tiers — NOTHING is ever owed. The platform generates its value from the
  //    user's ONGOING ACTIVITY over time (LTV), never as a fee, debt, or charge. ──────────────────────────
  { key: "FREE_ADVERTISER_TIER_ENABLED", label: "Free earn-to-unlock advertiser tier", category: "Earned Advertiser", type: "boolean", default: "1", help: "Enable the FREE tier: users pay nothing and owe nothing, and progressively UNLOCK advertiser benefits as a reward for their own activity. The platform's value comes from monetizing that activity over time (its LTV target), never from charging the user." },
  { key: "EARN_UNLOCK_METRIC", label: "Earn-to-unlock activity metric", category: "Earned Advertiser", type: "select", options: ["surveys", "active_days", "value_generated"], default: "surveys", help: "Which of the user's own activity counts toward unlocking advertiser benefits: surveys completed, active days, or cumulative platform value they've generated. Progress is a reward counter, never a balance owed." },
  { key: "EARN_UNLOCK_THRESHOLD_1", label: "Unlock threshold 1 — Starter", category: "Earned Advertiser", type: "number", default: "30", unit: "units", help: "Activity (in the chosen metric) to unlock the Starter advertiser grant (small impression credit + free AI creative for one product).", min: 0 },
  { key: "EARN_UNLOCK_THRESHOLD_2", label: "Unlock threshold 2 — Growing", category: "Earned Advertiser", type: "number", default: "120", unit: "units", help: "Activity to unlock the Growing grant (larger impression allotment + monthly AI social posts + analytics).", min: 0 },
  { key: "EARN_UNLOCK_THRESHOLD_3", label: "Unlock threshold 3 — Established", category: "Earned Advertiser", type: "number", default: "300", unit: "units", help: "Activity to unlock the Established grant (A/B testing + featured placement + sentiment insights).", min: 0 },
  { key: "EARN_UNLOCK_THRESHOLD_4", label: "Unlock threshold 4 — Earned Advertiser", category: "Earned Advertiser", type: "number", default: "730", unit: "units", help: "Activity to unlock the FULL advertiser package (parity with a paid Tier 1 advertiser). Reached through participation, never purchased.", min: 0 },
  { key: "FREE_TIER_SURVEY_SHARE_PCT", label: "Free-tier survey earn share", category: "Earned Advertiser", type: "number", default: "0.75", unit: "×", help: "The share a FREE-tier user keeps of their own third-party survey earnings (0.75 = keep 75%; the platform's 25% spread is part of how it generates its LTV). Free users are NOT on the Tier-1 100%-keep. Paid Tier 1 members keep 100% in-window.", min: 0, max: 1 },
  { key: "FREE_TIER_TERM_YEARS", label: "Free-tier participation term", category: "Earned Advertiser", type: "number", default: "4", unit: "years", help: "The participation term for the FREE earn-to-unlock tier (default 4 years). Members unlock and receive advertiser benefits over this period WHILE they participate. It is a program length + delivery schedule, NOT a binding obligation and NOT a debt: if they stop, future benefits simply stop delivering — they are never charged and never owe anything. Set 0 for no term (open-ended).", min: 0 },
    // Free earn-to-unlock ADVERTISER cost recovery (revenue-share, NON-RECOURSE). After a free-tier
  // advertiser has EARNED the $8,000 unlock over the participation term, the platform recovers the rest
  // of the $12,000 package value from a SHARE of the revenue the member generates — 10% until $12,000 is
  // reached, then 5% ongoing. It is NON-RECOURSE: taken only from actual revenue as it occurs; if there is
  // no revenue, nothing is taken and nothing is owed. Not a debt, not a fixed balance, never a charge.
  { key: "FREE_ADVERTISER_REVSHARE_TARGET_USD", label: "Free-advertiser total parity target", category: "Earned Advertiser", type: "number", default: "12000", unit: "$", help: "Total value the platform aims to realize from a FREE earn-to-unlock advertiser to reach parity with a paid $12,000/yr advertiser. The $8,000 earn-to-unlock value COUNTS toward this; the revenue-share only recovers the REMAINDER (default $12,000 − $8,000 = $4,000) at 10%, then 5% ongoing. NON-RECOURSE.", sensitive: true, min: 0 },
  { key: "FREE_ADVERTISER_EARN_UNLOCK_CREDIT_USD", label: "Earn-to-unlock value credited toward parity", category: "Earned Advertiser", type: "number", default: "8000", unit: "$", help: "The earn-to-unlock value ($8,000) that COUNTS toward the parity target, so the revenue-share only needs to recover (target − this) = ~$4,000 at 10%. Keep in sync with TARGET_USER_LTV_USD.", sensitive: true, min: 0 },
  { key: "FREE_ADVERTISER_REVSHARE_PCT", label: "Free-advertiser revenue share (until target)", category: "Earned Advertiser", type: "number", default: "0.10", unit: "×", help: "Share of the free-tier advertiser's BUSINESS revenue the platform takes until the remaining ~$4,000 (target − earn-to-unlock credit) is recovered (0.10 = 10%). Non-recourse: only applied to revenue that actually occurs.", sensitive: true, min: 0, max: 1 },
  { key: "FREE_ADVERTISER_REVSHARE_SOURCE", label: "Revenue-share source", category: "Earned Advertiser", type: "select", options: ["platform_attributed", "off"], default: "platform_attributed", help: "What counts as the advertiser's 'business revenue' for the share. 'platform_attributed' = ONLY sales that flow through the platform and are attributed to this advertiser (measurable + enforceable). Off-platform/self-reported revenue is intentionally NOT used. 'off' disables the share.", sensitive: true },
  { key: "REVSHARE_SALES_ENTITY", label: "Attributed-sales entity", category: "Earned Advertiser", type: "string", default: "Order", help: "The entity that records platform sales (default 'Order'). Change only if your attributed-sales live elsewhere (e.g. 'AffiliateSale')." },
  { key: "REVSHARE_SALES_ADVERTISER_FIELD", label: "Attributed-sales advertiser field", category: "Earned Advertiser", type: "string", default: "advertiser_id", help: "The field on the sales entity that links a sale to the advertiser it should be attributed to. Orders must be STAMPED with this when an ad drives the sale, or the share reads $0 (safe default)." },
  { key: "REVSHARE_SALES_AMOUNT_FIELD", label: "Attributed-sales amount field", category: "Earned Advertiser", type: "string", default: "amount", help: "The USD sale-amount field summed for the revenue share (default 'amount')." },
  { key: "REVSHARE_SALES_COUNTED_STATUSES", label: "Attributed-sales counted statuses", category: "Earned Advertiser", type: "string", default: "awaiting_shipment,shipped,delivered,fulfilled,completed,paid", help: "Comma-separated order statuses that count as realized revenue (only finalized/paid sales; excludes awaiting_payment, cancelled, refunded)." },
  { key: "FREE_ADVERTISER_REVSHARE_POST_PCT", label: "Free-advertiser revenue share (after target)", category: "Earned Advertiser", type: "number", default: "0.05", unit: "×", help: "Ongoing share of the free-tier advertiser's BUSINESS revenue AFTER parity is reached (0.05 = 5%), in perpetuity while they use the platform. Non-recourse.", sensitive: true, min: 0, max: 1 },
{ key: "TARGET_USER_LTV_USD", label: "Target lifetime value per engaged user (INTERNAL)", category: "Earned Advertiser", type: "number", default: "8000", unit: "$", help: "INTERNAL modeling target ONLY — the value the platform aims to generate by monetizing an engaged user's activity over their tenure. NEVER shown to the user, NEVER a price, NEVER a balance owed. For your dashboards/planning only.", min: 0 },
  // No-upfront Tier 1 advertiser (a 4-year PARTICIPATION program — not a debt).
  { key: "TIER1_NOUPFRONT_ENABLED", label: "No-upfront Tier 1 advertiser option", category: "Earned Advertiser", type: "boolean", default: "1", help: "Offer Tier 1 advertiser status with $0 upfront, on a participation basis: the advertising is delivered over a multi-year term as the member stays active. NOTHING is owed — if they stop, the remaining free advertising simply stops delivering; there is no charge, debt, or penalty." },
  { key: "TIER1_NOUPFRONT_TERM_YEARS", label: "No-upfront participation term", category: "Earned Advertiser", type: "number", default: "4", unit: "years", help: "The participation term for the no-upfront advertiser option. Free advertising is delivered across this term while the member participates. This is a delivery schedule and a condition of the FREE benefit — NOT a binding obligation and NOT a debt. Stopping early forfeits only the undelivered remainder.", min: 1 },
  { key: "TIER1_NOUPFRONT_ACTIVE_WINDOW_DAYS", label: "No-upfront: active-participation window", category: "Earned Advertiser", type: "number", default: "30", unit: "days", help: "A no-upfront member counts as 'participating' if active within this many days. If they lapse, delivery of the free advertising pauses (and resumes if they return) — never a charge.", min: 1 },
  { key: "EARNED_ADVERTISER_INTERSTITIAL_ENABLED", label: "Serve earned advertisers' ads in the between-survey slot", category: "Earned Advertiser", type: "boolean", default: "1", help: "Let earned/no-upfront advertisers' active creatives serve in the between-survey slot (after founding + paid PPC priority), so their unlocked/free advertising actually delivers while they participate." },
  // Weighted unlock — REFERRALS are the fastest, heaviest-weighted path (but NEVER required; surveys alone
  // still reach every level, so this stays a rewards program, not a recruitment requirement / pyramid).
  { key: "EARN_UNLOCK_WEIGHTED", label: "Weighted unlock score (surveys + referrals + activity)", category: "Earned Advertiser", type: "boolean", default: "1", help: "Compute unlock progress as a WEIGHTED score combining the member's surveys, their fraud-screened qualified referrals, and active days — instead of a single metric. Referrals are weighted heaviest, so referring is the fastest way to unlock. Referrals are NEVER required: a member can still reach every level through their own surveys alone." },
  { key: "EARN_WEIGHT_SURVEY", label: "Unlock weight: per survey", category: "Earned Advertiser", type: "number", default: "1", unit: "pts", help: "Unlock points per completed survey (the base unit; thresholds are in these points).", min: 0 },
  { key: "EARN_WEIGHT_REFERRAL", label: "Unlock weight: per qualified referral (HEAVIEST)", category: "Earned Advertiser", type: "number", default: "25", unit: "pts", help: "Unlock points per fraud-screened qualified referral (a referred person who joins and completes a first survey). Set the HEAVIEST so referrals are the fastest unlock. Default 25 = one referral advances you like 25 surveys. Only real, qualified referrals count — never raw invites/spam.", min: 0 },
  { key: "EARN_WEIGHT_ACTIVE_DAY", label: "Unlock weight: per active day", category: "Earned Advertiser", type: "number", default: "2", unit: "pts", help: "Unlock points per day the member is active. A small consistency bonus.", min: 0 },
  { key: "EARN_DAILY_REFERRAL_GOAL", label: "Daily referral goal (encouraged, not required)", category: "Earned Advertiser", type: "number", default: "3", unit: "referrals", help: "A daily referral target the member is ENCOURAGED to try for (default 3/day) — surfaced as a goal and rewarded via the heavy referral weight. It is NOT mandatory and there is NO penalty for missing it; referring is never required to unlock.", min: 0 },
  { key: "REFERRAL_INTERNAL_VALUE_USD", label: "Internal value per qualified referral (INTERNAL — never shown)", category: "Earned Advertiser", type: "number", default: "5", unit: "$", help: "INTERNAL accounting value of one qualified referral to the business (default $5). NEVER shown to any user — used only in your internal dashboards/models and stamped on the Referral record when it qualifies. Not a payout to the user.", min: 0 },
  // ── Contact-invite referral flow — COMPLIANT design: the user's OWN phone sends the messages (native SMS),
  //    never the server. This keeps it clear of TCPA/CAN-SPAM (no server-side blasting of un-consented numbers). ──
  { key: "REFERRAL_CONTACT_INVITE_ENABLED", label: "Contact-invite referral flow", category: "Earned Advertiser", type: "boolean", default: "1", help: "Enable the flow where a user grants contact access ON THEIR DEVICE, picks contacts, customizes the message with names, reviews, and sends from THEIR OWN phone (native SMS/share). The server never sends messages and never stores the contact list — only the referral link, an optional template, consent, and a daily count." },
  { key: "REFERRAL_INVITE_DAILY_CAP", label: "Invite daily cap (anti-spam)", category: "Earned Advertiser", type: "number", default: "50", unit: "invites", help: "Max referral invites a user can send per day (rate-limit to prevent spam/abuse and protect deliverability). The device-side flow enforces this via the server count.", min: 0 },
  { key: "REFERRAL_INVITE_BASE_URL", label: "Referral link base URL", category: "Earned Advertiser", type: "string", default: "https://gamergain.app", help: "Base URL for a user's personal referral link (link becomes <base>/?ref=<user id>)." },
  { key: "REFERRAL_INVITE_TEMPLATE", label: "Default invite message template", category: "Earned Advertiser", type: "string", default: "Hi {{name}}! I've been using GamerGain to earn rewards in my spare time — thought you'd like it. Join with my link: {{link}}", help: "Default, fully-customizable SMS template. {{name}} = the friend's name, {{link}} = the user's referral link. The user edits this before sending; it is sent from their own phone." },
  { key: "EARN_ONBOARDING_REQUIRE_INVITE_STEP", label: "Require the invite step in earn-to-unlock onboarding", category: "Earned Advertiser", type: "boolean", default: "1", help: "Make the contact-invite feature a REQUIRED onboarding step: every earn-to-unlock member is shown and prompted to try it. They must ACKNOWLEDGE the step to finish onboarding, but SENDING is optional and they can skip sending. This is an exposure/prompt requirement, NOT a requirement to actually refer anyone — the survey-only unlock path is always preserved, so it stays a rewards program (never a recruit-to-advance pyramid)." },
  { key: "REFERRAL_AI_DISCLOSURE_ENABLED", label: "AI referral copy: add reward disclosure", category: "Earned Advertiser", type: "boolean", default: "1", help: "Append an honest material-connection disclosure to AI-generated referral posts (FTC endorsement guidance), since referrers may earn a reward. Recommended ON." },
  { key: "REFERRAL_AI_DISCLOSURE", label: "AI referral copy: disclosure text", category: "Earned Advertiser", type: "string", default: "(Heads up — I may earn a reward if you join.)", help: "The short disclosure appended to AI-generated referral posts when the disclosure toggle is on." },
  { key: "FOUNDING_ADVERTISER_PRICE_USD", label: "Tier 1 advertiser price (annual, upfront)", category: "Founding Advertiser", type: "number", default: "12000", unit: "$", help: "Annual price of the Tier 1 advertising package ($12,000/yr, paid upfront). Monthly option available (see FOUNDING_ADVERTISER_MONTHLY_PRICE_USD).", min: 0 },
  { key: "FOUNDING_ADVERTISER_MONTHLY_PRICE_USD", label: "Tier 1 advertiser price (monthly, upfront)", category: "Founding Advertiser", type: "number", default: "1000", unit: "$", help: "Monthly option for the Tier 1 advertising package ($1,000/mo, paid upfront each month). 12 × $1,000 = $12,000/yr.", min: 0 },
  ...
  { key: "FOUNDING_LAUNCH_MILESTONE_PREMIUM_USERS", label: "Launch milestone — separate users", category: "Founding Advertiser", type: "number", default: "0", unit: "users", help: "SET TO 0 (default): in the first-year offer, founding members ARE the users, so there is no separate user gate — the single milestone is the founding-member count below. Set > 0 only if you ever want an additional, separate user requirement.", min: 0 },
  { key: "FOUNDING_LAUNCH_MILESTONE_FOUNDERS", label: "Launch milestone — founding members (= users)", category: "Founding Advertiser", type: "number", default: "100000", unit: "founders", help: "The single launch milestone: this many founding members, who are also the users. Founders sign up as members and use the site for the year, so you need 100,000 people total — not 100,000 founders PLUS 100,000 users. Escrow/delivery is gated on reaching this.", min: 0 },
  ...
  { key: "FOUNDING_SURVEY_EARN_SHARE_PCT", label: "Tier 1 survey earn share (in-window)", category: "Founding Advertiser", type: "number", default: "1", unit: "×", help: "During their window, Tier 1 members keep THIS share of what they earn from third-party surveys (1 = 100%). Earnings are paid as Site Cash — closed-loop store credit spendable ONLY on-site, not cash. The AMOUNT is variable, NOT guaranteed, and NO amount is promised — it is only the share of whatever they actually earn, and it is SEPARATE from (not a return of, or offset to) the advertising they bought.", min: 0, max: 1 },
  ...
  // Founding full-keep CAP — founding members keep 100% of survey earnings up to a cumulative cap, over a
  // window, then revert to standard member terms. COMPLIANCE: present this as a CAP on a variable, not-
  // guaranteed benefit. Do NOT market it as "earn back / recoup what you paid" — that's an FTC earnings claim
  // (survey inventory can't guarantee the amount) and, since the cap = the payment, a return-of-capital signal.
  // The mitigating fact: members earn it through their OWN survey work, not passively. Counsel-gated.
  { key: "FOUNDING_FULLKEEP_CAP_TO_PRICE", label: "Cap 100%-keep at amount paid (OFF)", category: "Founding Advertiser", type: "boolean", default: "0", help: "MUST stay OFF in the clean Tier 1 model. Pegging a cap to the amount paid reads as return-of-capital (an investment signal). The Tier 1 perk is a flat SHARE (keep 100% of what you earn) for a time window with NO cap and NO recoup framing — it is never tied to, and never 'earns back', the amount paid." },
  { key: "FOUNDING_FULLKEEP_CAP_USD", label: "Explicit 100%-keep cap (0 = none)", category: "Founding Advertiser", type: "number", default: "0", unit: "$", help: "Explicit cumulative cap on the 100%-keep benefit. Keep at 0 (no cap) in the clean Tier 1 model — a cap tied to a dollar figure reintroduces a return-of-capital signal. Left in place only for optionality.", min: 0 },
  { key: "FOUNDING_FULLKEEP_YEARS", label: "Tier 1 100%-keep window (years)", category: "Founding Advertiser", type: "number", default: "4", unit: "years", help: "A Tier 1 member keeps 100% of their own survey earnings for this many years, then reverts to the post-Tier-1 share (TIER1_POST_SURVEY_SHARE_PCT). No cap — it is a time-limited rate, not a recoup of the payment.", min: 1 },
  ...
  // ── Revenue-stack model: the blended $200k/yr goal across ALL business-funded lines, tracked over 5 years.
  // Reporting/planning only — this NEVER bills anyone. PPC advertiser LTV stays $12,000 (FOUNDING_ADVERTISER_PRICE_USD);
  // it is just ONE line inside the stack. See REVENUE-STACK-MODEL.md.
  { key: "REVENUE_STACK_ANNUAL_TARGET_USD", label: "Revenue-stack annual target", category: "Revenue", type: "number", default: "200000", unit: "$", help: "The blended annual revenue goal across every business-funded line (advertisers, subscriptions, sponsorships, commissions, breakage, spreads). Reporting only — the revenueStackReport measures progress toward it. Not a promise or a charge.", min: 0 },
  { key: "REVENUE_STACK_HORIZON_YEARS", label: "Revenue-stack projection horizon", category: "Revenue", type: "number", default: "5", unit: "years", help: "How many years the stack is projected over (5 → the $200k/yr target compounds to a ~$1M 5-year plan at flat run-rate).", min: 1, max: 25 },
  { key: "CUSTOMER_VALUE_HORIZON_YEARS", label: "Per-customer value horizon", category: "Revenue", type: "number", default: "5", unit: "years", help: "The window over which each business customer's value is projected (5 years). Their trailing run-rate is annualized and extended over this horizon.", min: 1, max: 25 },
  { key: "REVENUE_STACK_TARGET_BLEND", label: "Revenue-stack target blend (JSON)", category: "Revenue", type: "string", default: "{\"advertising\":96000,\"business_subscription\":30000,\"sponsored_placement\":20000,\"seller_commission\":15000,\"sourcing_margin\":10000,\"breakage\":15000,\"bnpl_merchant_fee\":5000,\"processing_rebate\":3000,\"shipping_margin\":2000,\"affiliate_commission\":2000,\"lead_fee\":2000}", help: "JSON map of RevenueEvent type → its annual $ target inside the stack (should sum to REVENUE_STACK_ANNUAL_TARGET_USD). Illustrative blend: PPC advertisers (advertising) $96k ≈ 8 seats × $12k, B2B SaaS $30k, sponsored $20k, and the activity-driven lines make up the rest. Tune freely; the report compares actuals to this." },
