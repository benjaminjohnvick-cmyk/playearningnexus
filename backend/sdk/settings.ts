...
export const REGISTRY: SettingDef[] = [
  ...
  { key: "FREE_ADVERTISER_REVSHARE_TARGET_USD", label: "Free-advertiser revenue-share target", category: "Earned Advertiser", type: "number", default: "12000", unit: "$", help: "Total package value the platform recovers from a FREE earn-to-unlock advertiser via revenue-share (default $12,000, matching the paid annual price). The $8,000 earn-to-unlock value counts toward reaching parity; the revenue-share recovers the remainder up to this figure. NON-RECOURSE — recovered only from actual revenue; never owed as a debt.", sensitive: true, min: 0 },
  { key: "FREE_ADVERTISER_REVSHARE_PCT", label: "Free-advertiser revenue share (until target)", category: "Earned Advertiser", type: "number", default: "0.10", unit: "×", help: "Share of the free-tier advertiser's generated revenue the platform takes UNTIL the $12,000 target is recovered (0.10 = 10%). Non-recourse: only applied to revenue that actually occurs.", sensitive: true, min: 0, max: 1 },
  { key: "FREE_ADVERTISER_REVSHARE_POST_PCT", label: "Free-advertiser revenue share (after target)", category: "Earned Advertiser", type: "number", default: "0.05", unit: "×", help: "Ongoing share of the free-tier advertiser's revenue AFTER the $12,000 target has been recovered (0.05 = 5%). Non-recourse.", sensitive: true, min: 0, max: 1 },
