...
export const REGISTRY: SettingDef[] = [
  ...
  { key: "MARKETPLACE_SELLER_COMMISSION_PCT", label: "Marketplace commission (charged to SELLER)", category: "Revenue", type: "number", default: "0.10", unit: "×", help: "Platform commission taken from the SELLER's proceeds on a marketplace sale — never added to the buyer's price.", min: 0, max: 1 },
