...
export const REGISTRY: SettingDef[] = [
  ...
  { key: "PREMIUM_DAILY_PORTION_USD", label: "Premium daily portion (Site Cash)", category: "Surveys", type: "number", default: "7", unit: "$/day", help: "Premium member's daily Site Cash portion ($7/day). $1/day of it is the subscription fee (PREMIUM_FINANCE_DAILY_USD), so premium nets ~$6/day. Closed-loop Site Cash — not a cash payout. Annual reference: $7 × 5 days/week × 52 = $1,820; $7 × 365 = $2,555.", min: 0 },
