...
export const REGISTRY: SettingDef[] = [
  ...
  { key: "CATALOG_LISTINGS_PER_COUNTRY", label: "Catalog listings per country", category: "Marketplace", type: "number", default: "320", min: 0, max: 5000, help: "Target number of original platform listings to keep active per country. The seeder tops up toward this (spread across all catalog categories). Images are generated once per new listing." },
  { key: "CATALOG_CATEGORIES", label: "Catalog categories (Amazon-breadth)", category: "Marketplace", type: "string", default: "Electronics,Computers,Smart Home,Arts Crafts & Sewing,Automotive,Baby,Beauty & Personal Care,Women's Fashion,Men's Fashion,Kids' Fashion,Health & Household,Home & Kitchen,Industrial & Scientific,Luggage & Travel,Movies & TV,Music,Pet Supplies,Software,Sports & Outdoors,Tools & Home Improvement,Toys & Games,Video Games,Books,Office Products,Garden & Outdoor,Grocery & Gourmet Food,Cell Phones & Accessories,Handmade,Collectibles,Appliances,Musical Instruments,Camera & Photo", help: "Comma-separated departments the catalog spans — set to match the breadth of categories a large retailer sells. The seeder distributes listings across all of them." },
