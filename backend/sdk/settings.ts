...
export const REGISTRY: SettingDef[] = [
  ...
  { key: "IMAGE_PROVIDER", label: "Image provider", category: "AI & Agents", type: "select", options: ["openai", "stability"], default: "openai" },
  { key: "IMAGE_MODEL", label: "Image model", category: "AI & Agents", type: "string", default: "dall-e-3" },
