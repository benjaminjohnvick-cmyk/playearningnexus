...
export const REGISTRY: SettingDef[] = [
  ...
  { key: "EARN_DAILY_CAP_USD", label: "Daily earn cap (Site Cash)", category: "Surveys", type: "number", default: "8", unit: "$", help: "Max Site Cash a user can earn per day from surveys. Same $8/day for both tiers by default.", min: 0 },
  ...
  { key: "PROVIDER_CPX_ENABLED", label: "Survey provider: CPX Research", category: "Surveys", type: "boolean", default: "0", help: "Add CPX Research inventory (needs CPX_APP_ID + CPX_SECRET). More supply = more earning hours." },
  { key: "PROVIDER_THEOREMREACH_ENABLED", label: "Survey provider: TheoremReach", category: "Surveys", type: "boolean", default: "0", help: "Add TheoremReach inventory (needs THEOREMREACH_API_KEY)." },
  { key: "PROVIDER_POLLFISH_ENABLED", label: "Survey provider: Pollfish", category: "Surveys", type: "boolean", default: "0", help: "Add Pollfish inventory (needs POLLFISH_API_KEY). Off until you sign them." },
  { key: "PROVIDER_INBRAIN_ENABLED", label: "Survey provider: InBrain", category: "Surveys", type: "boolean", default: "0", help: "Add InBrain.ai inventory (needs INBRAIN_API_KEY)." },
  { key: "PROVIDER_TAPRESEARCH_ENABLED", label: "Survey provider: TapResearch", category: "Surveys", type: "boolean", default: "0", help: "Add TapResearch inventory (needs TAPRESEARCH_API_KEY)." },
  { key: "PROVIDER_CINT_ENABLED", label: "Survey provider: Cint (Lucid)", category: "Surveys", type: "boolean", default: "0", help: "Add Cint/Lucid Marketplace inventory (needs CINT_API_KEY). Large enterprise supply for scale." },
  { key: "PROVIDER_ADGATE_ENABLED", label: "Survey provider: AdGate", category: "Surveys", type: "boolean", default: "0", help: "Add AdGate Media inventory (needs ADGATE_API_KEY)." },
  { key: "PROVIDER_AYET_ENABLED", label: "Survey provider: ayeT-Studios", category: "Surveys", type: "boolean", default: "0", help: "Add ayeT-Studios inventory (needs AYET_API_KEY)." },
  { key: "PROVIDER_REVLUM_ENABLED", label: "Survey provider: Revlum", category: "Surveys", type: "boolean", default: "0", help: "Add Revlum inventory (needs REVLUM_API_KEY)." },
  { key: "PROVIDER_PRODEGE_ENABLED", label: "Survey provider: Prodege", category: "Surveys", type: "boolean", default: "0", help: "Add Prodege (MySoapbox) inventory (needs PRODEGE_API_KEY)." },
  ...
  { key: "LLM_PROVIDER", label: "LLM provider", category: "AI & Agents", type: "select", options: ["openai", "anthropic", "self"], default: "openai", help: "self = your own OpenAI-compatible server (vLLM/Ollama/TGI running Llama/Mistral) at SELF_LLM_URL. Managed stays default; self falls back to managed on error." },
  ...
  { key: "IMAGE_PROVIDER", label: "Image provider", category: "AI & Agents", type: "select", options: ["openai", "stability", "aws_bedrock", "aws_sagemaker", "self"], default: "aws_bedrock", help: "Budget posture: aws_bedrock = serverless GPU, no infra, pay-per-image (cheapest with Titan). aws_sagemaker = your own SDXL/FLUX endpoint that scales to zero. self = a plain SDXL/FLUX HTTP server at SELF_IMAGE_URL. Needs AWS creds; if unset, catalog launches text-only at $0." },
  ...
  { key: "PROVIDER_STT", label: "Speech-to-text provider", category: "AI & Agents", type: "select", options: ["managed", "self"], default: "managed", help: "managed = OpenAI Whisper. self = your faster-whisper server (OpenAI-compatible) at SELF_STT_URL." },
  { key: "PROVIDER_TTS", label: "Text-to-speech provider", category: "AI & Agents", type: "select", options: ["managed", "self"], default: "managed", help: "managed = ElevenLabs (else device voice). self = your XTTS/Piper server at SELF_TTS_URL." },
