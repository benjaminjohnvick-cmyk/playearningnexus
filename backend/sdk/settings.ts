...
export const REGISTRY: SettingDef[] = [
  ...
  { key: "TIER1_POST_SURVEY_SHARE_PCT", label: "Post-Tier-1 survey earn share", category: "Founding Advertiser", type: "number", default: "0.75", unit: "×", help: "After the Tier 1 offer closes (availability cap reached), a member who joins keeps THIS share of their own third-party survey earnings; the platform keeps the rest as its fee (0.75 = member keeps 75%, platform fee 25%). Tier 1 members keep 100% for their window, then revert to this rate. Existing Tier 1 members are unaffected. Paid as closed-loop Site Cash; amount is variable and not guaranteed.", min: 0, max: 1 },
