...
const CATALOG: Deliverable[] = [
  // A. Advertising media
  { key: "between_survey_impressions", group: "A_media", name: "Between-survey interstitial impressions (5,000,000/yr)", annual_value_usd: 110000, qty_per_year: 5000000, ai_served: true, engine: "adGridFeed", cadence: "continuous", basis: "~$22 CPM, premium high-attention first-party in-app inventory" },
  { key: "video_views", group: "A_media", name: "Rewarded / in-survey video views (1,000,000/yr)", annual_value_usd: 18000, qty_per_year: 1000000, ai_served: true, engine: "adGridFeed", cadence: "continuous", basis: "~$18 CPM video" },
  { key: "homepage_featured", group: "A_media", name: "Homepage & category featured placement", annual_value_usd: 18000, qty_per_year: null, ai_served: true, engine: "createAdGridAd", cadence: "continuous", basis: "fixed premium placement (~$1,500/mo)" },
  { key: "sponsor_wall", group: "A_media", name: "Premier sponsor-wall / category-priority placement", annual_value_usd: 12000, qty_per_year: null, ai_served: true, engine: "createAdGridAd", cadence: "continuous", basis: "sponsorship / priority premium (~$1,000/mo)" },
  // B. Creative & content production
  { key: "managed_ad_creative", group: "B_creative", name: "Managed ad-creative production (display/native, 2x-monthly refresh)", annual_value_usd: 18000, qty_per_year: 24, ai_served: true, engine: "aiCreativeContentGeneator", cadence: "monthly", basis: "AI creative generation (agency-retainer equivalent, AI-priced)" },
  { key: "social_ad_posts", group: "B_creative", name: "Managed social ad posts (1,800/yr)", annual_value_usd: 22500, qty_per_year: 1800, ai_served: true, engine: "autoPostContentToSocial", cadence: "monthly", basis: "managed social content (~$12.50/post)" },
  { key: "email_campaigns", group: "B_creative", name: "Dedicated email campaigns to opted-in audience (18/yr)", annual_value_usd: 13500, qty_per_year: 18, ai_served: true, engine: "autoEmailSequenceEngine", cadence: "monthly", basis: "email marketing service (~$750 each)" },
  { key: "sponsored_newsletters", group: "B_creative", name: "Sponsored newsletter placements (9/yr)", annual_value_usd: 13500, qty_per_year: 9, ai_served: true, engine: "autoEmailSequenceEngine", cadence: "bimonthly", basis: "~$1,500 each" },
  // C. Research, data & insights
  { key: "audience_panels", group: "C_research", name: "Custom audience-panel research studies (5/yr)", annual_value_usd: 60000, qty_per_year: 5, ai_served: true, engine: "createAudiencePanel", cadence: "quarterly", real_respondents: true, basis: "~$12,000 each; AI-designed & analyzed, fielded to REAL consented respondents" },
  { key: "brand_lift_studies", group: "C_research", name: "Brand-lift / ad-effectiveness studies (3/yr)", annual_value_usd: 18000, qty_per_year: 3, ai_served: true, engine: "createAudiencePanel", cadence: "semiannual", real_respondents: true, basis: "~$6,000 each; exposed/control measured on REAL respondents" },
  { key: "competitive_reports", group: "C_research", name: "Category & competitive insights reports (6/yr)", annual_value_usd: 15000, qty_per_year: 6, ai_served: true, engine: "aiStrategicInsightsEngine", cadence: "quarterly", basis: "~$2,500 each; AI synthesis of first-party + category data" },
  { key: "data_feed_api", group: "C_research", name: "First-party audience data feed + API access", annual_value_usd: 15000, qty_per_year: null, ai_served: true, engine: "platformInsights", cadence: "continuous", basis: "aggregate, consent-gated data-product access (~$1,250/mo)" },
  // D. Managed service, analytics & optimization
  { key: "ai_campaign_manager", group: "D_service", name: "Always-on AI campaign manager + optimization (human escalation available)", annual_value_usd: 54000, qty_per_year: null, ai_served: true, engine: "aiAdCampaignOptimizer", cadence: "continuous", basis: "AI campaign management + quarterly strategy with optional human escalation (~$4,500/mo); NOT sold as a dedicated human" },
  { key: "analytics_dashboard", group: "D_service", name: "Advanced analytics & attribution dashboard", annual_value_usd: 9600, qty_per_year: null, ai_served: true, engine: "aiSurveyInsightsDashboard", cadence: "continuous", basis: "~$800/mo SaaS-equivalent" },
  { key: "ab_testing", group: "D_service", name: "Multivariate / A-B testing program", annual_value_usd: 7200, qty_per_year: null, ai_served: true, engine: "abTestAssigner", cadence: "continuous", basis: "testing tooling + AI analysis (~$600/mo)" },
];
