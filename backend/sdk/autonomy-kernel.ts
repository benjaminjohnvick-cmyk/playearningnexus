...
export const DOMAINS: DomainDef[] = [
  ...
  { id: "load_time", label: "Page load-speed optimization", group: "ops", klass: "auto_ok", default_mode: "manual", gateable: true, wired: true, note: "AI tunes safe speed knobs (route prefetch aggressiveness) to keep load times under the ~80ms perception budget. Reversible, non-sensitive — never money/identity/legal. Routes through perfOptimize + the optimizer's revert-on-regression, so it feeds the custom model's training + the per-function eval." },
